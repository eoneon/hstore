class ItemsController < ApplicationController
  ...
  def item_params
    ...
    params.require(:item).permit(:name, :image_width, :image_height, :item_type_id, :mounting_type_id, :certificate_type_id, :signature_type_id, :substrate_type_id, { :titles_attributes => [:id, :title] } ).tap do |whitelisted| #{ :artist_items_attributes => [:id, :artist_id, :item_id] }
